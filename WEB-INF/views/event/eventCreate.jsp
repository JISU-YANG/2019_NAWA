        ...
        <div class="container">
          ...
          <div class="collapse navbar-collapse navbar-dash">
            <ul class="nav navbar-nav mr0">
              ...
              <li class="">
                <a href="../user/dashboard"><i class="fa fa-tachometer icon-dash" aria-hidden="true"></i> Dashboard</a>
              </li>
              </c:if>
              <li class="">
                <a href="../project/index"><i class="fa fa-list icon-dash" aria-hidden="true"></i> Main</a>
              </li>
            </ul>
          </div>
        </div>
...
<section class="clearfix bg-dark listingSection" id="listing-add-edit" >
	<div class="container">
		<div class="row">
			<div class="col-xs-12">
				<form action="../event/create" method="post" class="listing__form" enctype="multipart/form-data" id="eventcreateForm">
					<div class="dashboardBoxBg mb30">
						<div class="profileIntro paraMargin">
							<h3>이벤트 정보</h3>
							<p>NAWA는 모임중개서비스이며 모임참가의 당사자가 아닙니다. 따라서 NAWA는 이벤트 정보 및 진행에 대하여 책임을 지지 않습니다.</p>
							<div class="row">
								<div class="form-group col-sm-6 col-xs-12">
									<label for="listingTitle">이벤트 제목</label>
									<input type="text" name="ef_title" class="form-control" id="listingTitle" placeholder="ex) 같이 영화볼 사람 구해요!">
								</div>
								<div class="form-group col-sm-6 col-xs-12">
									<label for="listingTitle">개설자 닉네임</label>
									<input type="text" name="mi_nck" class="form-control" id="listingNck" value="${LDto.mi_nck}" readonly="readonly">
								</div>
								<div class="form-group col-sm-6 col-xs-12">
								...
								<div class="form-group col-sm-6 col-xs-12">
									...
									<input type="number" name="ef_num_cnt" class="form-control" id="listingNum" placeholder="ex) 5" min="2" max="20">
								</div>
								<div class="form-group col-sm-6 col-xs-12">
							...
							<div style="margin-top: 115px;">
									...
									<input name="ef_attend_con" type="text" class="form-control" id="addTags" placeholder="ex) 25세 이상 , 민증 필수">
							</div>
					</div>
					<div class="dashboardBoxBg mb30">
						<div class="profileIntro paraMargin">
							...
							<div class="row">
								...
								<div class="form-group col-sm-6 col-xs-12">
									<label for="listingAddress">상세주소</label>
									<input name="show_address" type="text" class="form-control" id="listingAddress" placeholder="Type Location" required="required">
									<input name="ef_lc_detail" type="hidden" id="latlng">
								</div>
					...
					<div class="dashboardBoxBg mb30">
						<div class="profileIntro paraMargin">
							...
							<div class="row">
								...
								<input type="hidden" name="decide" id="decide" value="eventbasic">
								...
								<div class="img_area">
									...
									<input type="file" name="basicfile" id="basicfile" onchange="showPreview(this)">
									<a onclick="resetPreview()">취소</a>
								</div>
					...
					<div class="form-footer text-center">
						<input type="submit" class="btn-submit" value="Submit" id="eventcreate">
