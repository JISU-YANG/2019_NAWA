...
<header id="pageTop" class="header">
   ...
   <div class="nav-wrapper">
      <!-- NAVBAR -->
      <nav id="menuBar" class="navbar navbar-default transparent-navbar "
         role="navigation">
         <div class="container">
            ...
            <div class="navbar-header">
               ...
               <a class="navbar-brand" href=".."> <svg class="logo-svg"
                     version="1.1" style="margin: 10px 0px;" height="30px" id="레이어_1"
                     xmlns="http://www.w3.org/2000/svg"
                     xmlns:xlink="http://www.w3.org/1999/xlink" x="0px" y="0px"
                     viewBox="0 0 175.2 105.1"
                     style="enable-background:new 0 0 175.2 105.1;"
                     xml:space="preserve">
<path class="path-1"
                        d="M147.1,6.1C139.8,2.2,131.5,0,122.6,0c-11,0-21.6,3.5-30.4,9.7c-1.6,1.1-3.2,2.4-4.7,3.7
...
<path class="path-1"
                        d="M45.3,72.3c-0.9,1.3-2.8,1.7-4.1,0.8c-1.3-0.9-1.7-2.8-0.8-4.1l35.1-51.1c2.2-3,4.7-5.7,7.3-8.1
   C74.1,3.5,63.5,0,52.5,0C23.6,0,0,23.6,0,52.5c0,17.6,8.7,33.1,22,42.6l18-24.5L22,95.2" />
<path class="path-1"
                        d="M129.9,32.8c0.9-1.3,2.8-1.7,4.1-0.8c1.3,0.9,1.7,2.8,0.8,4.1L99.6,87.2c-2.2,3-4.7,5.7-7.3,8.1
