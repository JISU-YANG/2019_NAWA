...
<body id="body" class="body-wrapper boxed-menu">
	<div class="main-wrapper">
		...
		<section class="clearfix bg-dark listingSection" id="listing-add-edit">
			<div class="container">
				<div class="row">
					<div class="col-xs-12">
						<form action="../event/recresuccess" method="post"
							class="listing__form" id="eventcreateForm"
							...
							<div class="dashboardBoxBg mb30">
								<div class="profileIntro paraMargin">
									...
									<p>NAWA는 모임중개서비스이며 모임참가의 당사자가 아닙니다. 따라서 NAWA는 이벤트 정보 및 진행에
										대하여 책임을 지지 않습니다.</p>
									<input type="hidden" name="ef_id" value="${edto.ef_id}">
									<input type="hidden" name="ef_refer" value="${edto.ef_refer}">
									<div class="row">
										<div class="form-group col-sm-6 col-xs-12">
											<label for="listingTitle">이벤트 제목</label> <input type="text"
												name="ef_title" class="form-control" id="listingTitle"
												value="${edto.ef_title}" readonly="readonly">
										</div>
										<div class="form-group col-sm-6 col-xs-12">
											<label for="listingTitle">개설자 닉네임</label> <input type="text"
												name="mi_nck" class="form-control" id="listingNck"
												value="${LDto.mi_nck}" readonly="readonly">
										</div>
										<div class="form-group col-sm-6 col-xs-12">
											<label for="listingCategory">공개여부</label>
											<div class="contactSelect">
												<select name="ef_open_status" id="listingOpenStatus"
													class="select-drop">
										...
										<div class="form-group col-sm-6 col-xs-12">
											<label for="listingTitle">이벤트 인원</label> <input type="number"
												name="ef_num_cnt" class="form-control" id="listingNum"
												placeholder="ex) 5" min="2" max="20">
										</div>
										<div class="form-group col-sm-6 col-xs-12">
								...
								<div style="margin-top: 115px;">
									<label for="addTags">참가 조건</label> <input name="ef_attend_con"
										type="text" class="form-control" id="addTags"
										placeholder="ex) 25세 이상 / 민증 필수">
								</div>
							</div>
							<div class="dashboardBoxBg mb30">
								<div class="profileIntro paraMargin">
									...
									<div class="row">
										...
										<div class="form-group col-sm-6 col-xs-12">
											<label for="listingAddress">상세주소</label> <input type="text"
												...
												placeholder="Type Location" value=""> <input
										...
										<div class="form-group col-sm-6 col-sm-pull-6 col-xs-12">
											<label for="listingPhone">연락처</label> <input type="text"
												class="form-control" id="listingPhone"
												placeholder="${phone}" readonly="readonly">
										</div>

										<div class="form-group col-sm-6 col-sm-pull-6 col-xs-12">
											<label for="listingEmail">이메일</label> <input type="text"
												class="form-control" id="listingEmail"
							...
							<div class="dashboardBoxBg mb30">
								<div class="profileIntro paraMargin">
									...
									<div class="img_thumbnail">
										<img class="thumbnail_r" src="../upload/eventbasic.jpg">
									</div>
								</div><br> 
												
												<input
												type="file" name="basicfile" id="basicfile"
												onchange="showPreview(this)" multiple="multiple"><a
										...
										<div class="form-group col-xs-12">
											...
											<div id="eventfilelist" style="height: 150px"></div>
										</div>
									</div>
								</div>
							</div>
									...
									<div class="row">
										<div class="col-sm-6 col-xs-12">
											<div class="dateSelect">
												...
												<div class="input-group date ed-datepicker filterDate"
													...
													<input type="text" name="ef_event_start"
										...
										<div class="col-sm-6 col-xs-12">
											<div class="dateSelect">
												...
												<div class="input-group date ed-datepicker filterDate"
													data-provide="datepicker">
													<input type="text" name="ef_deadline" class="form-control"
							...
							<div class="form-footer text-center">
								<button type="submit" class="btn-submit" id="eventcreate">Submit</button>
							</div>
						</form>
					</div>
				</div>
	...
	<script type="text/javascript">
		...
		$j(function() {
			...
			$j('#eventcreateForm input[name=file]').MultiFile({
				max : 5,
				accept : 'jpg|png|gif',
	...
	<script type="text/javascript">
		...
		$('#guiest_id19 option[value=${edto.ef_lc}]').attr('selected',
				'selected');
